...
import com.sh8121.springcore.archive.v0_basic.bean.v1.BeanA;
import com.sh8121.springcore.archive.v0_basic.bean.v1.BeanB;
import com.sh8121.springcore.archive.v0_basic.bean.v1.BeanC;
...
@Configuration
@ComponentScan(basePackages = "com.sh8121.springcore.archive.v0_basic.bean.v1")
